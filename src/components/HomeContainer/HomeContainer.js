    ...
    return (
        ...
        <div>
            <div className="home-container">
                <img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/mb-metris-gallery-passenger-van-02-1578419740.jpg?crop=0.752xw:1.00xh;0.0529xw,0&resize=640:*" alt="about" className="image" />
            ...
            <div className="home-container">
                <img src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="about" className="image" />
                <div className="overlay overlayFade">
                    <div className="text">
            ...
            <div className="home-container">
                <img src="https://images.unsplash.com/photo-1464038008305-ee8def75f234?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="about" className="image" />
                <div className="overlay overlayFade">
                    <div className="text">
